...
var (
	scc  *contractapi.ContractChaincode
...
func init() {
	...
	scc, err := contractapi.NewChaincode(airplaneCon, flightCon)
	if err != nil {
		panic(err.Error())
	}
	stub = shimtest.NewMockStub("airstub", scc)
}
...
func TestInit(t *testing.T) {
	args := SetupArgsArray("Init")

	response := stub.MockInit("Init", args)
